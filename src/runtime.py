...
def build_agent(trajectory, initial_working=None, pinned_plan=None, memory=None):
    ...
    system_prompt = build_system_prompt(config.TOOL_MODE, tools, memory=memory)
